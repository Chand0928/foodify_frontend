    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
                <div className="absolute top-[-10%] right-[-5%] w-96 h-96 rounded-full bg-indigo-300/30 blur-3xl"></div>
                <div className="absolute bottom-[-10%] left-[-5%] w-96 h-96 rounded-full bg-purple-300/30 blur-3xl"></div>
            </div>
            ...
            <div className="max-w-md w-full space-y-8 relative z-10 bg-white/80 backdrop-blur-lg p-8 rounded-3xl shadow-2xl border border-white/50">
                <div>
                    <h2 className="mt-2 text-center text-3xl font-extrabold text-gray-900">Sign in to Foodify</h2>
